...
class Game extends Model    // Объявление класса Game, наследующего Eloquent Model
{
    ...
    public function genre() // Определение отношения принадлежности к жанру
    {
        return $this->belongsTo(Genre::class);  // Возвращает отношение "многие к одному" с моделью Genre
    }
    ...
    public function incrementViews()    // Метод для увеличения счётчика просмотров
    {
        $this->increment('views_count');    // Инкрементирует поле views_count в базе данных
    }
}
